...
const { apiLink, basePath } = require('../src/config/vars');
...
describe('Boiler Backend APIs', () => {
    ...
    describe('User Login Tests', () => {
        ...
        it('Should not be able to login with wrong credentials', (done) => {
            const dataToSend = {
                ...
                method: 'POST',
                json: {
                    email: 'vdfvdfsv@blockgemini.com',
                    password: '123435445',
                },
                headers: {},
            };
    ...
    describe('User Register Tests', () => {
        it('Should Register User', (done) => {
            const emailName = randomString.generate({ length: 8 });
            const firstName = randomString.generate({ length: 8 });
            const lastName = randomString.generate({ length: 8 });
            const dataToSend = {
                ...
                json: {
                    firstName,
                    lastName,
                    email: `${emailName.toString()}@blockgemini.com`,
                    password: 'Qwerty@123',
